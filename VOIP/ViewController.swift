...
let baseURLString = "https://qa-app-backend.woodleup.com/VoiceCallTest/"
...
let accessTokenEndpoint = "/accessToken_APN_T.php"

//Claire.orange
//let identity = "VOICE25"

//Gurjot
var identity = "VOICE498"
...
class ViewController: UIViewController {
    ...
    @IBOutlet var myID_tf: UITextField!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        myID_tf.text = identity
        outgoingValue.text = "VOICE25"
    ...
    func fetchAccessToken() -> String? {
        self.info_lbl.text = "from: \(identity) to: \(outgoingValue.text!)"
